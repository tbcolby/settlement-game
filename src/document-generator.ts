...
Generated by Settlement Game v${msa.version} on ${this.formatDate(msa.generatedDate)}
Co-Authored-By: Warp <agent@warp.dev>
This document was created through collaborative gameplay and requires attorney review before filing.
`;
  }
